...
import logging
import boto3
from mylib.lib import read_s3_csv, write_s3_csv, extract_bart_torvik_data

logging.basicConfig(
    filename="logs/read_write_files_s3.log",
    level=logging.INFO,
...
# Extract and write current live data
logging.info("Extracting and saving current live data.")
